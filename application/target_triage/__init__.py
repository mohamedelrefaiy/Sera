"""Target Triage — rank + adversarially verify druggable T-cell regulators.
...
Import the layer you need directly (e.g. `from target_triage.core import
compute_shortlist`). This root stays import-light on purpose: pulling in core/ or
llm/ loads the screen CSVs at import, so a bare `import target_triage` should not.
"""
