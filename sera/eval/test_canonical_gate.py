...
Sera's whole claim is *agents on the rim, deterministic instrument at the hub*. This file is
...
Run as a gate:    python sera/eval/test_canonical_gate.py    (prints PASS/FAIL)
Run under pytest: pytest sera/eval/test_canonical_gate.py
"""
...
from sera.core.canonical import (  # noqa: E402
...
from sera.core.concordance import (  # noqa: E402
    Config, MrnaEffect, ProteinEffect, _direction, classify)
from sera.rim.adapters import (  # noqa: E402
...
def _run_gate() -> bool:
    """Print the numbers, PASS/FAIL. Mirrors the house style of test_sera_sanity.py."""
