...
What makes Sera more than two hardcoded loaders is that a screen it has never seen can be
...
class AxisExtract(str, Enum):
    ...
    string. Sera reconciles PER CYTOKINE, so comparing that string against Zhu's "IL2" finds no
