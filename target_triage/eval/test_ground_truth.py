...
The "known biology" panel asserts that Concord independently recovers the canonical IL-2
...
def test_most_canonical_regulators_are_recovered():
    """Concord must recover the large majority of textbook IL-2 positive regulators — a low
