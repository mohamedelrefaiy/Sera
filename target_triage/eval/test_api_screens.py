...
def test_schmidt_impact_is_really_derived_from_the_fdr():
    ...
    from target_triage.core.data import load_screen
    from target_triage.core.ranking import significant_records
    from target_triage.core.schema import SCHMIDT2022
