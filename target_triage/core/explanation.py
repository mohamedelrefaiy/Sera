...
SYSTEM_PROMPT = (
    ...
    "How to write:\n"
    "- Speak their language: what the knockout DID, what each screen SAW, and why it matters. "
    "Follow the arc — what you did to the gene, what happened to the transcript, what happened to "
    "the protein, why that pattern makes sense.\n"
    ...
    "mechanism the record does not support. If a side is untested, say that screen did not measure "
    "this gene — do not guess.\n"
